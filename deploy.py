...
async def cmd_setup(args):
    ...
    print_section("DevPlane Setup for glondor.xyz")
    ...
    try:
        ...
        print_success("DevPlane is configured for glondor.xyz")
        print()
        print("Next steps:")
...
def main():
    parser = argparse.ArgumentParser(
        description="DevPlane Deployment Script for glondor.xyz",
