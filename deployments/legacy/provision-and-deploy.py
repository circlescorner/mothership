...
TUNNEL_NAME = os.environ.get("TUNNEL_NAME", "devplane-vps-tunnel")
DROPLET_NAME = os.environ.get("DROPLET_NAME", "devplane-vps")
DROPLET_IMAGE = os.environ.get("DROPLET_IMAGE", "ubuntu-22-04-x64")  # Ubuntu 22.04 LTS
DROPLET_REGION = os.environ.get("DROPLET_REGION", "nyc1")  # New York 1
DEPLOY_DIR = os.environ.get("DEPLOY_DIR", "/opt/devplane")
SSH_USER = "root"
